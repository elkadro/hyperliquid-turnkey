...
export class Hyperliquid {
  ...
  constructor(turnkeySigner: any | null = null, testnet: boolean = false, walletAddress: string, _prepMeta: any, _spotMeta: any, _proxy?: string, _vaultAddress?: string | null) {
